...
public class CrmTest {
    ...
    void project() {
        ...
        driver.findElement(By.xpath("//div[text()='1234123']")).click();
    ...
    @Test
    @DisplayName("Создать контактное лицо")
    void person(){
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
        ...
        driver.findElement(By.xpath("//span[.='Укажите организацию']")).click();
        driver.findElement(By.xpath("//div[text()='12341234']")).click();
        driver.findElement(By.name("crm_contact[jobTitle]")).sendKeys("QA");
        driver.findElement(By.xpath("//button[contains(.,'Сохранить и закрыть')]")).click();
        WebElement savePerson = driver.findElement(By.xpath("//*[text()='Контактное лицо сохранено']"));
